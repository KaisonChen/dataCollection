/* 鼠标跟随七彩星星特效 欧攀的博客 www.oupan0612.com */
...
(function() {
	...
	q(function() {
		...
		window.giffy_bp_0013 = {
			...
			init: function() {
				for (i = 0; i < 1; i++) {
					var j = "http://www.oupan0612.com/upload/star/subball" + (i + 1) + ".png";
					giffy_bp_0013.ballImageResource[i] = new Image;
					giffy_bp_0013.ballImageResource[i].src = j
				}
				for (i = 0; i < 8; i++) j = "http://www.oupan0612.com/upload/star/subball" + (i + 1) + ".png", giffy_bp_0013.subBallImageResource[i] =
