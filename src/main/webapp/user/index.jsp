...
<script type="text/javascript" src="../js/mymouse.js" id="mymouse"></script>
    <%--<script type="text/javascript" src="../js/bootstrap.min.js" id="mymouse"></script>--%>
<!--[if lt IE 9]>
    ...
    <!--nav-->
     <div id="nav">
        <ul>
         ...
         <li><a href="../user/about.jsp">关于我</a></li>
         <li><a href="../user/shuo.jsp">碎言碎语</a></li>
         <li><a href="../user/riji.jsp">个人日记</a></li>
         <li><a href="../user/xc.jsp">相册展示</a></li>
         <li><a href="../user/learn.jsp">学无止境</a></li>
         <li><a href="../user/guestbook.jsp">留言板</a></li>
         <div class="clear"></div>
        </ul>
      </div>
       <!--nav end-->
